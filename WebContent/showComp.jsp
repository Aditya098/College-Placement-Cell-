...
<!--start-banner-->
	<div class="banner banner1" id="home">
			...
			<div class="logo">
				...
				<span class="style4">The LNM Institute of InformationTechnology </span></div>
				  ...
				  <div class="banner-top">
						<h1>Welcome</h1>
						    <div align="center"><strong><br><br>
					            <a href="student.jsp" class="style15"> Student info</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                        <a href="showAlumni.jsp" class="style15"> Alumni</a>
							</strong></div>
					</div>
				</div>
			</div>	
	...
	<div class="container">
		<div class="idea-top">
			...
			<% 
                ...
                //out.print(s);
                if(s !=null){
					currentCompany = userDao.showComp(s,currentUser); 
                }%>
      			<% for(Company b: currentCompany) {%>
					<h3><%= b.getName()  %></h3>
					<p align="justify">
					Package: <%= b.getPackage() %><br>
					id <%= b.getid() %><br>
					Field:<%= b.getField() %><br>
					Applied: <%= b.getCount() %><br>
					Skills: <% ArrayList<String> str = new ArrayList<String>();
								str = userDao.showSkills(b);
									for(String si: str) { %>
									<%= si %>
									<% } %>
					<br><br>
			...
			<a href="apply.jsp"><input type="submit" value="Apply"  name="clickit" class="button small color"> </a><br>
			</td></div>
