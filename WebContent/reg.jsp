...
<html>
<head>
	<title>Placements | STUDENT REGISTER</title>
...
<div class="gwrapper" style="padding:0;width:100%">
	...
	<div class="container clearfix">
		<br/><br/><h1>STUDENT REGISTER</h1><hr/></br>

		<p></p>
		<br/><br/>
		<form name="student_login" action="y" method="post" class="form-elements" style="color:#4E4E4E">
			<table id="table_login" width="450px">
				...
				<col width="50">
                    ...
                    <tr>
                        <td>Email</td>
                        <td><input type="text" name="email" value="" size="20" maxlength="50"/></td>
                    </tr>
                    <tr>
                        <td>Field</td>
