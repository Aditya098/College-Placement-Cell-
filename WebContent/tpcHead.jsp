				  ...
				  <div class="banner-top">
						<h1>Welcome</h1>
						    <div align="center"><strong><br><br>
					            <a href="tpcReg.jsp" >Tpc member register</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="Tdel.jsp" >Delete tpc member</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="TshowComp.jsp" >Show Company</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="TshowStud.jsp" >Show student</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="TshowAlumni.jsp" >Show alumni</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="showTpc.jsp" >Show tpc members</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
