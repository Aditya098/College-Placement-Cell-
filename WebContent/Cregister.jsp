...
<html>
<head>
	<title>Placements | Company REGISTER</title>
...
<!--start-banner-->
	<div class="banner banner1" id="home">
			...
			<div class="logo">
				...
				<span class="style4">The LNM Institute ofInformation Technology </span></div>
...
<div class="gwrapper" style="padding:0;width:100%">
	...
	<div class="container clearfix">
		<br/><br/><h1>Company REGISTER</h1><hr/></br>

		<p></p>
		<br/><br/>
		<form name="student_login" action="Cregister" method="post" class="form-elements" style="color:#4E4E4E">
...
<tr>
                    ...
                    <tr>
                        <td>Password</td>
                        <td><input type="password" name="password" value="" size="20" maxlength="50"/></td>
                    </tr>
                    <tr>
                        <td>Package</td>
                        <td><input type="text" name="Package" value="" size="20" maxlength="50"/></td>
                    </tr>
                    <tr>
                        <td>Field</td>
                        <td><input type="text" name="Field" value="" size="20" maxlength="50"/></td>
                    </tr>
                    <tr>
                        <td>pointer</td>
                        <td><input type="text" name="Pointer" value="" size="20" maxlength="50"/></td>
                    </tr>
           ...
           <% if(!Company.rflag){
            	out.print("passwod and username taken");
            	Company.rflag=true;
            }%>
