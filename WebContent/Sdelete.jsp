...
<html>
<head>
	<title>Placements | STUDENT DELETE</title>
...
<div class="gwrapper" style="padding:0;width:100%">
	...
	<div class="container clearfix">
		<br/><br/><h1>STUDENT DELETE</h1><hr/></br>

		<p></p>
		<br/><br/>
		<form name="alumni_login" action="Sdel" method="get" class="form-elements" style="color:#4E4E4E">
