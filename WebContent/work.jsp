...
<html>
<head>
	<title>Placements | Add work</title>
...
<div class="gwrapper" style="padding:0;width:100%">
	...
	<div class="container clearfix">
		<br/><br/><h1>ADD INFO</h1><hr/></br>

		<p></p>
		<br/><br/>
		<form name="alumni_work" action="work" method="get" class="form-elements" style="color:#4E4E4E">
			<table id="table_login" width="450px">
				<col width="50">
				<col width="50">
				<% alumni currentUser = (alumni)session.getAttribute("currentSessionUser");%>
                	<% if(currentUser.getWork().equals("research")){%>
                	<tr>
					<td>Skill</td> 
					<td><input type="text" name="skill" size="20" maxlength="50"/></td>
				</tr>
                    <tr>
                        <td>Topic</td>
                        <td><input type="text" name="Topic" size="20" maxlength="50"/></td>
                    </tr>
                    <tr>
                        <td>CorField</td>
                        <td><input type="text" name="CorField" size="20" maxlength="50"/></td>
                    </tr>
                    <tr>
                        <td>Stipend</td>
                        <td><input type="text" name="Stipend" size="20" maxlength="50"/></td>
                    </tr>
                    <% } else if(currentUser.getWork().equals("startup")){ %>
                   	 <tr>
                        <td>Topic</td>
                        <td><input type="text" name="Topic" size="20" maxlength="50"/></td>
                    </tr>
                    <tr>
                        <td>Startup Name</td>
                        <td><input type="text" name="stName" size="20" maxlength="50"/></td>
                    </tr>
                    <tr>
                        <td>Stipend</td>
                        <td><input type="text" name="Stipend" size="20" maxlength="50"/></td>
                    ...
                    <tr>
                        <td>Vacancy</td>
                        <td><input type="text" name="vacancy" size="20" maxlength="50"/></td>
                    </tr>
                    <% } else { %>
                    <tr>
                        <td>Post</td>
                        <td><input type="text" name="Post" size="20" maxlength="50"/></td>
                    </tr>
                    <tr>
                        <td>Company</td>
                        <td><input type="text" name="Company" size="20" maxlength="50"/></td>
                    </tr>
                    <tr>
                        <td>Package</td>
                        <td><input type="text" name="Package" size="20" maxlength="50"//></td>
                    </tr>
                    <% } %>	
			...
			<div id="button">
				<td colspan="2" style="text-align:left">
					<input type="submit" value="Enter"  name="clickit" class="button small color"> 
				</td>
			</div>
