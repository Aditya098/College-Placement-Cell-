...
<div class="banner-main">
				  ...
				  <div class="banner-top">
						<h1>Welcome</h1>
						    <div align="center"><strong><br><br>
					            <a href="reg.jsp" class="style15"> Student register</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                        <a href="Areg.jsp" class="style15"> alumni register</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                        <a href="Cregister.jsp" class="style15"> Company register</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                        <a href="Cdel.jsp" class="style15"> delete Company</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                        <a href="Adel.jsp" class="style15"> delete alumni</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                        <a href="Sdelete.jsp" class="style15"> delete Student</a>
							</strong></div>
					</div>
				</div>
			</div>	
	...
	<body>
		...
		<table class="table-fill">
		<tbody class="table-hover">
            <% tpcMember currentUser = (tpcMember)session.getAttribute("currentSessionUser");%>
			...
			<tr>
				<td class="text-left">Free Slot</td>
				<td class="text-left"><%=currentUser.getFreeSlot()%></td>
			...
			<tr>
				...
				<a href="logout">
				<input type="submit" value="Logout"  name="clickit" class="button small color"><br>
				</a>
		</td>
		</form>
	<!--start-footer-->
