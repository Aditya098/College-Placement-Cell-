...
<html>
<head>
	<title>Placements | TPC REGISTER</title>
...
<div class="gwrapper" style="padding:0;width:100%">
	...
	<div class="container clearfix">
		<br/><br/><h1>TPC REGISTER</h1><hr/></br>

		<p></p>
		<br/><br/>
		<form name="student_login" action="Tregister" method="post" class="form-elements" style="color:#4E4E4E">
...
<tr>
                    ...
                    <tr>
                        <td>Position</td>
                        <td><input type="text" name="position" size="20" maxlength="50" /></td>
                    </tr>
                    <tr>
                        <td>year</td>
                        <td><input type="text" name="year" size="20" maxlength="50" /></td>
                    </tr>
                    <tr>
                        <td>free Slot</td>
                        <td><input type="text" name="freeSlot" size="20" maxlength="50" /></td>
                    </tr>	
