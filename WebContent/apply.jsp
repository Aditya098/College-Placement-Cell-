...
<div class="gwrapper" style="padding:0;width:100%">
	...
	<div class="container clearfix">
		<br/><br/><h1> Apply </h1><hr/></br>

		<p></p>
		<br/><br/>
		<form name="alumni_login" action="apply" method="post" class="form-elements" style="color:#4E4E4E">
			...
			<div id="button">
				<td colspan="2" style="text-align:left">
					<input type="submit" value="Apply"  name="clickit" class="button small color"> 
				</td>
			</div>
