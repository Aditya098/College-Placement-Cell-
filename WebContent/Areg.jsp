...
<html>
<head>
	<title>Placements | ALUMNI REGISTER</title>
...
<div class="gwrapper" style="padding:0;width:100%">
	...
	<div class="container clearfix">
		<br/><br/><h1>ALUMNI REGISTER</h1><hr/></br>

		<p></p>
		<br/><br/>
		<form name="student_login" action="Aregister" method="post" class="form-elements" style="color:#4E4E4E">
			<table id="table_login" width="450px">
				<col width="50">
				<col width="50">
<tr>
                        <td>User Name</td>
                        <td><input type="text" name="name" value=""  size="20" maxlength="50"/></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                    ...
                    <tr>
                        <td>work</td>
                        <td><input type="text" name="work" value="" size="20" maxlength="50"/></td>
                    </tr>
                    <tr>
                        <td>batch</td>
                        <td><input type="text" name="batch" value="" size="20" maxlength="50"/></td>
                    </tr>
           ...
           <% if(!alumni.rflag){
            	out.print("password and username taken");
            	alumni.rflag=true;
            }%>
