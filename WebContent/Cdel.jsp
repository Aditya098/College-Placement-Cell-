...
<html>
<head>
	<title>Placements | COMPANY DELETE</title>
...
<div class="gwrapper" style="padding:0;width:100%">
	...
	<div class="container clearfix">
		<br/><br/><h1>COMPANY DELETE</h1><hr/></br>

		<p></p>
		<br/><br/>
		<form name="alumni_login" action="Cdel" method="get" class="form-elements" style="color:#4E4E4E">
			...
			<div id="button">
				<td colspan="2" style="text-align:left">
					<input type="submit" value="DELETE"  name="clickit" class="button small color"> 
				</td>
			</div>

		</table>
		<% if(!tpcMember.dflag) 
			out.print("please check again");
		%>
	</form>
