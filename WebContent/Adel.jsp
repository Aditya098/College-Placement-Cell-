...
<html>
<head>
	<title>Placements | ALUMNI DELETE</title>
...
<div class="gwrapper" style="padding:0;width:100%">
	...
	<div class="container clearfix">
		<br/><br/><h1>ALUMNI DELETE</h1><hr/></br>

		<p></p>
		<br/><br/>
		<form name="alumni_login" action="Adel" method="get" class="form-elements" style="color:#4E4E4E">
