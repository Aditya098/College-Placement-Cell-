...
<body>
		...
		<tbody class="table-hover">
            <% Company currentUser = (Company)session.getAttribute("currentSessionUser");%>
			...
			<tr>
				...
				<td class="text-left"><%=currentUser.getPackage()%></td>
			</tr>
			<tr>
				<td class="text-left">Field</td>
				<td class="text-left"><%=currentUser.getField()%></td>
		...
		<div id="button">
			<td colspan="2" style="text-align:left">
				<a href ="Cskills.jsp">
					<input type="submit" value="Add skill"  name="clickit" class="button small color">
				</a> 
			</td>
			</div>
			<div id="button">
				<a href ="showCstud.jsp">
					<td colspan="2" style="text-align:left">
