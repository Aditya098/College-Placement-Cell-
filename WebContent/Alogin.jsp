...
<html>
<head>
	<title>Placements | Alumni Login</title>
...
<div class="gwrapper" style="padding:0;width:100%">
	...
	<div class="container clearfix">
		<br/><br/><h1>Alumni Login</h1><hr/></br>

		<p></p>
		<br/><br/>
		<form name="alumni_login" action="Alogin" method="post" class="form-elements" style="color:#4E4E4E">
