...
<html>
<head>
	<title>Placements | Student Skill</title>
...
<div class="gwrapper" style="padding:0;width:100%">
	...
	<div class="container clearfix">
		...
		<p></p>
		<br/><br/>
		<form name="student_login" action="z" method="get" class="form-elements" style="color:#4E4E4E">
			<table id="table_login" width="450px">
				...
				<tr>	
					<td>Intern:</td>
					<td><input type="text" name="intern" size="20" maxlength="50"/><br/><br/></td>
				</tr>	
