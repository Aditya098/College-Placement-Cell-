				  ...
				  <div class="banner-top">
						<h1>Welcome</h1>
						    <div align="center"><strong><br><br>
					            <a href="showComp.jsp" class="style15"> Company</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                        <a href="showAlumni.jsp" class="style15"> Alumni</a></font>
							</strong></div>
					</div>
				</div>
			</div>	
	...
	<div class="container">
		...
		<tbody class="table-hover">
			...
			<tr>
				...
				<td class="text-left"><%=currentUser.getField()%></td>
				
			</tr>
			<tr>
				<td class="text-left">Work</td>
				<td class="text-left"><%=currentUser.getWork()%></td>
			</tr>
			<tr>
				<td class="text-left">Batch</td>
				<td class="text-left"><%=currentUser.getBatch()%></td>
			</tr>
		</tbody>
		</table>
		</form>
		<div id="button">
			<td colspan="2" style="text-align:left">
				<a href ="showStud.jsp">
					<input type="submit" value="Show student"  name="clickit" class="button small color">
				</a> 
			</td>
			</div>
			<div id="button">
				<a href ="work.jsp">
					<td colspan="2" style="text-align:left">
						<input type="submit" value="Add work"  name="clickit" class="button small color"> 
					</td>				
				</a>
			</div>
			<div id="button">
				<a href ="logout">
					<td colspan="2" style="text-align:left">
						<input type="submit" value="Logout"  name="clickit" class="button small color"> 
					</td>
				</a>
			</div>
	<!--start-footer-->
